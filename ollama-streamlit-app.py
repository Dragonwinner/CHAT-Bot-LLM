...
def main():
    ...
    #
    model = st.sidebar.selectbox("Choose a model", ["deepseek-coder-v2:latest","llama3.3:70b-instruct-q2_K","llama3.1:8b","llama3.3:latest" ,"llama3.2:latest","phi4:latest","llama3.2-vision:11b"])
